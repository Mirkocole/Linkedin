...
export default function Usercard({user}) {
  ...
  return (
        ...
        <div className='p-3 my-2 border d-flex flex-column align-items-center'>
            ...
            <Button variant='outline-dark' className='my-2 mx-auto d-flex align-items-center' onClick={()=> navigate(`/profile/${user._id}`)}><TiUserAdd className='me-1' />Collegati</Button>
        </div>
  )
}
